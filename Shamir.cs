...
public record Shamir
{
        ...
        bool extendable = true)
    {
        ...
        var id = (uint16)(BitConverter.ToUInt16(RandomNumberGenerator.GetBytes(4)) & ((1 << Share.ID_LENGTH_BITS) - 1));
    ...
    uint8[] Value)
{
    ...
    private static int ID_EXP_LENGTH_WORDS = Bits2Words(ID_LENGTH_BITS + EXTENDABLE_FLAG_LENGTH_BITS + ITERATION_EXP_LENGTH_BITS);
